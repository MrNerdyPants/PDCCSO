...
case object oFunctionsMillion {
  ...
  def readOptVector(name: String): Array[Double] = {
    val path = "/usr/local/Kashan/files2000/" + name + "-xopt.txt"
  ...
  def readPermVector(name: String): Array[Int] = {
    val path = "/usr/local/Kashan/files2000/" + name + "-p.txt"
   // val stream: InputStream = getClass.getResourceAsStream(path)
  ...
  def readSVector(name: String): Array[Int] = {
    val path = "/usr/local/Kashan/files2000/" + name + "-s.txt"
    //val stream: InputStream = getClass.getResourceAsStream(path)
  ...
  def readWVector(name: String): Array[Double] = {
    val path = "/usr/local/Kashan/files2000/" + name + "-w.txt"
    //val stream: InputStream = getClass.getResourceAsStream(path)
  ...
  def readRotationalMatrix(name: String, value: Int): Array[Array[Double]] = {
    val path = "/usr/local/Kashan/files2000/" + name + "-R" + value + ".txt"
    //val stream: InputStream = getClass.getResourceAsStream(path)
