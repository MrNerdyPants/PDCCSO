...
object scratch1 extends Serializable {
  ...
  def sccsa(mi : Int, Pop : Int,dim : Int,min : Double,max : Double,max_it : Int,selection : Int,casef : String)={
    ...
    var  changepop=BroadcastWrapper(  sc,  sortedpopulation  )
    ...
    val mii=BroadcastWrapper(sc,mi)
     ...
     var fl=BroadcastWrapper(sc, population(0).flight(max_it, 0))
    var coflag=BroadcastWrapper(sc,false)
    var chflag=BroadcastWrapper(sc,false)
    var delta1 :Double=0
    var delta2 :Double=0
    var l1 :Double=0
    var l2 :Double=0
